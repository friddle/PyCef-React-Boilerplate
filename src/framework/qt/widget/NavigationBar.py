...
class NavigationBar(QFrame):
    def __init__(self, cef_widget):
        ...
        self.devTools = self.createButton("devTools")
        self.devTools.clicked.connect(self.onOpenDevTools)
        layout.addWidget(self.devTools, 0, 3)
    ...
    def onOpenDevTools(self):
        if self.cef_widget.browser:
            self.cef_widget.browser.ShowDevTools()
    ...
    def createButton(self, name):
        resources = os.path.abspath(os.path.join(os.path.abspath(os.path.dirname(__file__)),
                                                 "../../../../resources/icons/"))
